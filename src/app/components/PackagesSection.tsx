...
const additionalServices: ServiceType[] = [
  {
    id: "treasure-hunt",
    name: "Участь у BEST Treasure Hunt",
    price: 160,
    info: "Інтерактивна гра для залучення студентів",
  },
  {
    id: "simulation",
    name: "Симуляція співбесід",
    price: 130,
    info: "Можливість провести симуляції співбесід з потенційними кандидатами",
  },
  {
    id: "cv-access",
    name: "Доступ до бази CV учасників",
    price: 110,
    info: "Отримайте доступ до бази резюме всіх учасників події",
  },
  {
    id: "telegram",
    name: "Промоція кар'єрних можливостей компанії в Telegram-боті події",
    price: 120,
    info: "Розміщення інформації про вакансії та можливості в офіційному боті події",
  },
  {
    id: "article",
    name: "Стаття про компанію на сайті BEST Lviv",
    price: 90,
    info: "Публікація детальної статті про вашу компанію на нашому сайті",
  },
  {
    id: "linkedin",
    name: "Індивідуальний пост про компанію в LinkedIn",
    price: 80,
    info: "Окремий пост про вашу компанію в нашій LinkedIn спільноті",
  },
  {
    id: "instagram",
    name: "Закріплені Instagram stories",
    price: 80,
    info: "Закріплені stories про вашу компанію в нашому Instagram",
  },
];
